...
function getR32Slots(): KnockoutSlot[] {
  return [
    { matchId: "R32_01", round: "r32", homeLabel: "1A", awayLabel: "3C/D/E", homeSource: "1A", awaySource: "3C", label: "R32-1" },
    { matchId: "R32_02", round: "r32", homeLabel: "1B", awayLabel: "3A/C/D", homeSource: "1B", awaySource: "3A", label: "R32-2" },
    { matchId: "R32_03", round: "r32", homeLabel: "1C", awayLabel: "3D/E/F", homeSource: "1C", awaySource: "3D", label: "R32-3" },
    { matchId: "R32_04", round: "r32", homeLabel: "1D", awayLabel: "3E/F/G", homeSource: "1D", awaySource: "3E", label: "R32-4" },
    { matchId: "R32_05", round: "r32", homeLabel: "1E", awayLabel: "3F/G/H", homeSource: "1E", awaySource: "3F", label: "R32-5" },
    { matchId: "R32_06", round: "r32", homeLabel: "1F", awayLabel: "3G/H/I", homeSource: "1F", awaySource: "3G", label: "R32-6" },
    { matchId: "R32_07", round: "r32", homeLabel: "1G", awayLabel: "3H/I/J", homeSource: "1G", awaySource: "3H", label: "R32-7" },
    { matchId: "R32_08", round: "r32", homeLabel: "1H", awayLabel: "3I/J/K", homeSource: "1H", awaySource: "3I", label: "R32-8" },
    { matchId: "R32_09", round: "r32", homeLabel: "1I", awayLabel: "3J/K/L", homeSource: "1I", awaySource: "3J", label: "R32-9" },
    { matchId: "R32_10", round: "r32", homeLabel: "1J", awayLabel: "3K/L/A", homeSource: "1J", awaySource: "3K", label: "R32-10" },
    { matchId: "R32_11", round: "r32", homeLabel: "1K", awayLabel: "3L/A/B", homeSource: "1K", awaySource: "3L", label: "R32-11" },
    { matchId: "R32_12", round: "r32", homeLabel: "1L", awayLabel: "3B/C/D", homeSource: "1L", awaySource: "3B", label: "R32-12" },
    ...
    { matchId: "R32_17", round: "r32", homeLabel: "2I", awayLabel: "2J", homeSource: "2I", awaySource: "2J", label: "R32-17" },
    { matchId: "R32_18", round: "r32", homeLabel: "2K", awayLabel: "2L", homeSource: "2K", awaySource: "2L", label: "R32-18" },
    { matchId: "R32_19", round: "r32", homeLabel: "3A", awayLabel: "3B", homeSource: "3A", awaySource: "3B", label: "R32-19" },
    { matchId: "R32_20", round: "r32", homeLabel: "3C", awayLabel: "3D", homeSource: "3C", awaySource: "3D", label: "R32-20" },
  ]
}
...
function getR16Slots(): KnockoutSlot[] {
  return [
    ...
    { matchId: "R16_09", round: "r16", homeLabel: "W R32-17", awayLabel: "W R32-18", homeSource: "W17", awaySource: "W18", label: "R16-9" },
    { matchId: "R16_10", round: "r16", homeLabel: "W R32-19", awayLabel: "W R32-20", homeSource: "W19", awaySource: "W20", label: "R16-10" },
  ]
}

function getQfSlots(): KnockoutSlot[] {
  return [
    { matchId: "QF_01", round: "qf", homeLabel: "W R16-1", awayLabel: "W R16-2", homeSource: "W21", awaySource: "W22", label: "QF-1" },
    { matchId: "QF_02", round: "qf", homeLabel: "W R16-3", awayLabel: "W R16-4", homeSource: "W23", awaySource: "W24", label: "QF-2" },
    { matchId: "QF_03", round: "qf", homeLabel: "W R16-5", awayLabel: "W R16-6", homeSource: "W25", awaySource: "W26", label: "QF-3" },
    { matchId: "QF_04", round: "qf", homeLabel: "W R16-7", awayLabel: "W R16-8", homeSource: "W27", awaySource: "W28", label: "QF-4" },
    { matchId: "QF_05", round: "qf", homeLabel: "W R16-9", awayLabel: "W R16-10", homeSource: "W29", awaySource: "W30", label: "QF-5" },
  ]
}

function getSfSlots(): KnockoutSlot[] {
  return [
    { matchId: "SF_01", round: "sf", homeLabel: "W QF-1", awayLabel: "W QF-2", homeSource: "W31", awaySource: "W32", label: "SF-1" },
    { matchId: "SF_02", round: "sf", homeLabel: "W QF-3", awayLabel: "W QF-4", homeSource: "W33", awaySource: "W34", label: "SF-2" },
  ]
}

function getFinalSlots(): KnockoutSlot[] {
  return [
    { matchId: "F_01", round: "final", homeLabel: "W SF-1", awayLabel: "W SF-2", homeSource: "W35", awaySource: "W36", label: "Final" },
  ]
}
